...
const mapDispatchToProps = dispatch => ({
  ...
  postFeedback: (fisrtname, lastname, telnum, email, agree, contactType, message) => dispatch(postFeedback(fisrtname, lastname, telnum, email, agree, contactType, message)),
});
...
class Main extends Component{
  ...
  render(){
    ...
    const DishwithId = ({match}) =>{
      return(
        <Detaildish dish ={this.props.dishes.dishes.filter((dish) => dish.id===parseInt(match.params.dishId,10))[0]}
